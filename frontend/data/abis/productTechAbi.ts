export const PRODUCT_TECH_ABI = [
  {
    inputs: [
      { internalType: "uint256", name: "productFee", type: "uint256" },
      { internalType: "uint256", name: "holderFee", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: "string", name: "_productSlug", type: "string" },
      { indexed: true, internalType: "address", name: "_trader", type: "address" },
      ...
      { indexed: false, internalType: "uint256", name: "_sellPrice", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "_nextPrice", type: "uint256" },
    ],
